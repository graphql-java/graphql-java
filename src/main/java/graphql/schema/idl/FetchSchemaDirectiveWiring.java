...
public class FetchSchemaDirectiveWiring implements SchemaDirectiveWiring {
    ...
    private String atFetchFromSupport(String fieldName, List<GraphQLDirective> directives) {
        ...
        return from.map(arg -> (String) ValuesResolver.valueToInternalValue(arg.getArgumentValue(), arg.getType(), GraphQLContext.getDefault(), Locale.getDefault())).orElse(fieldName);
    }
