...
//                Edge edgeToDummyTypeVertex = assertNotNull(oldSchemaGraph.getSingleAdjacentEdge(deletedVertex, edge -> edge.getTwo().getType().equals(SchemaGraph.DUMMY_TYPE_VERTEX)));
