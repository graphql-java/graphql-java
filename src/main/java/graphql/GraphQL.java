...
public class GraphQL {
    ...
    public ExecutionResult execute(String query, Object context) {
        return execute(query, context, Collections.emptyMap());
    }
    ...
    public ExecutionResult execute(String query, String operationName, Object context) {
        return execute(query, operationName, context, Collections.emptyMap());
    }
     ...
     */
    @Deprecated
    public ExecutionResult execute(String query, Object context, Map<String, Object> arguments) {
        return execute(query, null, context, arguments);
    }
    ...
    public ExecutionResult execute(ExecutionInput executionInput) {
        ...
        log.debug("Executing request. operation name: {}. Request: {} ", operationName, query);
