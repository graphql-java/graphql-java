...
import graphql.validation.rules.UniqueInputField;
...
public class Validator {
    ...
    private List<AbstractRule> createRules(ValidationContext validationContext, ValidationErrorCollector validationErrorCollector) {
        ...
        UniqueInputField uniqueInputField=new UniqueInputField(validationContext, validationErrorCollector);
        rules.add(uniqueInputField);
