...
class OverlappingFieldsCanBeMergedTest extends ValidationRuleTest {
    ...
    def traverse(String query, GraphQLSchema schema) {
        ...
        ValidationContext validationContext = new ValidationContext(schema, document, assertingI18N())
