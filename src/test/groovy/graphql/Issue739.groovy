...
class Issue739 extends Specification {
    ...
    def "Arguments passed via variables are not validated"() {
        ...
        varResult.errors[0].message == "Variable 'input' has an invalid value : Variable 'input' has an invalid value : Expected type 'Map' but was 'Integer'. Variables for input objects must be an instance of type 'Map'.";
//        varResult.errors[0].locations == [new SourceLocation(1, 11)]
        ...
        varResult.errors[0].message == "Variable 'input' has an invalid value : Variable 'input' has an invalid value : Variable 'boom' has an invalid value : Expected type 'Int' but was 'String'."
//        varResult.errors[0].locations == [new SourceLocation(1, 11)]
    }
}
