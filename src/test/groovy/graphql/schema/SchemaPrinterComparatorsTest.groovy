...
'''
    ...
    def "scalarPrinter uses most specific registered comparators"() {
        ...
        def registry = newComparators()
                ...
                .addComparator({ it.parentType(GraphQLAppliedDirective.class).elementType(GraphQLAppliedArgument.class) }, GraphQLAppliedArgument.class, TestUtil.byGreatestLength)
                .build()
...
'''
    ...
    def "scalarPrinter uses least specific registered comparators"() {
        ...
        def registry = newComparators()
                ...
                .addComparator({ it.elementType(GraphQLAppliedArgument.class) }, GraphQLAppliedArgument.class, TestUtil.byGreatestLength)
                .build()
...
'''
    ...
    def "objectPrinter uses most specific registered comparators"() {
        ...
        def registry = newComparators()
                ...
                .addComparator({ it.parentType(GraphQLAppliedDirective.class).elementType(GraphQLAppliedArgument.class) }, GraphQLArgument.class, TestUtil.byGreatestLength)
                .build()
        def options = defaultOptions().setComparators(registry)
        def result = new SchemaPrinter(options).print(objectType)
