...
class ScalarsTest extends Specification {
    ...
    @Unroll
    def "String serialize/parseValue #value into #result"() {
        expect:
    ...
    @Unroll
    def "ID serialize/parseValue #value into #result"() {
        expect:
    ...
    @Unroll
    def "Boolean serialize/parseValue #value into #result"() {
        expect:
    ...
    @Unroll
    def "Char serialize/parseValue #value into #result"() {
        expect:
