...
A naive approach would be to make two queries to get he most important data first but there is now a better way.
...
like web sockets and so on.  That is important but not a concern of the base graphql-java library.  It's up to you
