 ...
 *
 * To manage test performance, test suites that extend ArbPropertyBase will be run with
...
abstract class ArbPropertyBase(
    ...
    init {
        println("[ArbPropertyBase] ${this::class.simpleName} seed=$seed")
    }
